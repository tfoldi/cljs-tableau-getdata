...
var G__12443 = o;
(G__12443[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_12447 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_12447))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12447)].join(''):class$));
} else {
}
...
var G__12450 = jsprops;
(G__12450["defaultValue"] = value);

(G__12450["onChange"] = ((function (G__12450,v,value,on_change){
return (function (p1__12448_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12448_SHARP_);
});})(G__12450,v,value,on_change))
);
...
var vec__12452 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12452,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12452,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12452,(2),null);
...
var temp__4427__auto__ = (function (){var G__12454 = cljs.core.meta(v);
var G__12454__$1 = (((G__12454 == null))?null:reagent.impl.template.get_key(G__12454));
return G__12454__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__12456_12457 = v;
var G__12456_12458__$1 = (((G__12456_12457 == null))?null:reagent.impl.template.key_from_vec(G__12456_12457));
var G__12456_12459__$2 = (((G__12456_12458__$1 == null))?null:(jsprops["key"] = G__12456_12458__$1));
...
var G__12463 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12463) : reagent.impl.template.as_element.call(null,G__12463));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__12464 = cljs.core.meta(argv);
var G__12464__$1 = (((G__12464 == null))?null:reagent.impl.template.get_key(G__12464));
return G__12464__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__12465 = (((jsprops == null))?{}:jsprops);
(G__12465["key"] = key);
...
var n__7358__auto___12466 = a.length;
var i_12467 = (0);
while(true){
if((i_12467 < n__7358__auto___12466)){
(a[i_12467] = reagent.impl.template.as_element((a[i_12467])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7358__auto___12469 = a.length;
var i_12470 = (0);
while(true){
if((i_12470 < n__7358__auto___12469)){
var val_12471 = (a[i_12470]);
if((cljs.core.vector_QMARK_(val_12471)) && ((reagent.impl.template.key_from_vec(val_12471) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12470] = reagent.impl.template.as_element(val_12471));
...
var G__12474 = (cljs.core.count(argv) - first_child);
switch (G__12474) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12474){
